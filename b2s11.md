...
- Utilizando la case clase que construyó, como tarea, lea los datos del dataset de movies y trate de responder a las siguientes preguntas:
  ...
  - ¿Cuántos ﬁlas son `Left`?
    ...
    ![image](https://github.com/user-attachments/assets/f2ca21fd-2061-4eac-b248-883682472376)
    

    ![image](https://github.com/user-attachments/assets/e4992585-683f-4f1c-ac54-3a9c18aacbbf)

    
    ![image](https://github.com/user-attachments/assets/a83baa81-53a3-493d-860b-682565cf6da4)


- Ahora modiﬁque el case class para que el atributo runtime sea del tipo
`Option[Double]` y vuelva a responder las preguntas anteriores.

 En este caso al momento de realizar el cambion a "[Option] Double", los resultado que nos presentan son los mismos que el caso anterior.
